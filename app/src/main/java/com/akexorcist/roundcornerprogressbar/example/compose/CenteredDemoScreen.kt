...
import com.akexorcist.roundcornerprogressbar.compose.CenteredRoundCornerProgressBar
import com.akexorcist.roundcornerprogressbar.example.R

/**
 * Compose version of `CenteredDemoFragment` with the same samples.
 */
@Composable
fun CenteredDemoScreen() {
    DemoScreenContainer {
        SectionTitle(text = stringResource(R.string.title_centered_round_corner_progress_bar))
        InteractiveCenteredCard()
        SampleCard {
...
@Composable
private fun InteractiveCenteredCard() {
    SampleCard {
